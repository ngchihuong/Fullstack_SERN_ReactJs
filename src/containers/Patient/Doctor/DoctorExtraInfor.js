                ...
                <div className='content-down'>
                    {isShowDetailInfor === false &&
                        <div className='short-infor'>
                            ...
                            <span className='detail' onClick={() => this.handleShowHideDetailInfor(true)}><FormattedMessage id="patient.extra-infor-doctor.view-detail"/></span>
                        </div>
                    }
                    {isShowDetailInfor === true &&
                        <>
                            ...
                            <div className='detail-infor'>
                                ...
                                <div className='note'>
                                    {extraInfor && extraInfor.note ? extraInfor.note : ''} </div>
                            </div>
                            ...
                            <div className='hide-price'>
                                <span onClick={() => this.handleShowHideDetailInfor(false)}><FormattedMessage id="patient.extra-infor-doctor.hide-detail"/></span>
                            </div>
                        </>
                    }
